...
def ask_gemini(question, choices, hint, image):
    ...
    prompt = f"Question: {question}\nChoices: {choices}\nHint: {hint}\n\n(Note: There is only one correct answer.) Please proceed with a step-by-step analysis and provide a rationale."
...
def main():
    ...
    results_file = 'rationale_results_forward_t6.json'
